...
export const SUBSCRIPTION_PLANS: Readonly<Record<SubscriptionPlanId, Readonly<SubscriptionPlan>>> = Object.freeze({
  starter: definePlan({
    ...
    monthlyGrantCreditMicros: 1_000 * CREDIT_MICROS_PER_CREDIT,
  ...
  creator: definePlan({
    ...
    monthlyGrantCreditMicros: 2_500 * CREDIT_MICROS_PER_CREDIT,
  ...
  pro: definePlan({
    ...
    monthlyGrantCreditMicros: 6_000 * CREDIT_MICROS_PER_CREDIT,
  ...
  studio: definePlan({
    ...
    monthlyGrantCreditMicros: 15_000 * CREDIT_MICROS_PER_CREDIT,
    topUpMoneyMicrosPerCredit: 8_000,
    modelAccessNote: 'All verified model families included.',
    autoReloadAvailable: true,
  }),
})
