...
- `202607290001_generation_settlement_lock_order.sql` replaces the three generation terminal-settlement RPCs so they lock the owning credit account before the reservation, matching capture, release and expiry and preventing cross-worker deadlocks.
